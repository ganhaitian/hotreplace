...
package com.windhot.hotreplace.reflection;
...
import com.windhot.hotreplace.data.ClassData;
...
public class FieldReflection {
    ...
    public static boolean isFakeField(Field f) {
        if ((f.getModifiers() & Modifier.STATIC) == 0 && f.getDeclaringClass().getName().startsWith(Constants.GENERATED_CLASS_PACKAGE)) {
            return true;
        }
        return false;
    }
