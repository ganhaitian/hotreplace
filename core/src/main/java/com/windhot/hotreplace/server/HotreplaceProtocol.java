...
package com.windhot.hotreplace.server;
 ...
 * @author GanHaitian
 */
public class HotreplaceProtocol {

    private static final Logger log = Logger.getLogger(HotreplaceProtocol.class);
